...
from .models import DopUser, SubRubric, SuperRubric
from .models import user_registrated, Bb, DopImage
...
AIFormSet = forms.inlineformset_factory(Bb, DopImage, fields='__all__')
